...
-- Keep cursor in the middle while scrolling up or down
vim.keymap.set("n", "<C-d>", "<C-d>zz")
vim.keymap.set("n", "<C-u>", "<C-u>zz")

-- Paste without deleting current register
vim.keymap.set("x", "<leader>p", "\"_dP")

-- Shortcut to yanking to system clipboard
vim.keymap.set("n", "<leader>y", "\"+y")
vim.keymap.set("v", "<leader>y", "\"+y")
vim.keymap.set("n", "<leader>Y", "\"+Y")

-- Shortcut to pasting to system clipboard
